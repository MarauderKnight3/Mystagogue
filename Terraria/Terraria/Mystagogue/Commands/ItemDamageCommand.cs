...
{
	public ItemDamageCommand() : base("dmg", "[Desired damage] The selected item in your hotbar will have this damage value to work with. Run without a specification to undo this change.") { }
	protected internal override void Execute(List<string> args)
	{
		...
		if (args.Count > 0) {
			...
			// Holler
			Output("Damage set to " + Main.player[Main.myPlayer].HeldItem.damage);
		}
		else {
			...
			// Holler
			Output("Damage set to default: " + Main.player[Main.myPlayer].HeldItem.damage);
		}
	}
}
